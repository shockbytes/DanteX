enum DanteEvent {
  openTermsOfServices, // done
  resetPasswordSuccess, // done
  resetPasswordFailed, // done
  reportLoginProblem, // TODO
  openLogin, // done
  appLogin, // done
  appSignUp, // done
  appLogout, // done
  anonymousUpgrade, // done
  updateMailPasswordSuccess, // done
  updateMailPasswordFailure, // done
  userNameChanged, // TODO
  userImageChanged,
  backupMade,
  interestedInOnlineStorage,
  startImport,
  openBackupFile,
